...
const StudentParticipationandActivities = () => {
    ...
    return (
      <>
        ...
        <Banner
          isFrontBanner={false}
          bannerImg={bannerImg}
          heading={"Student Participation and Activities"}
        />
         <Features
          sectionGap="both"
          SectionImage={Logo}
  ...
  export default StudentParticipationandActivities;
