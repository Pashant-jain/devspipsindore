...
const FinancialManagementandResourceMobilization = () => {
    ...
    return (
      <>
        ...
        <Banner
          isFrontBanner={false}
          bannerImg={bannerImg}
          heading={"Financial Management and Resource Mobilization"}
        />
         <Features
          sectionGap="both"
          SectionImage={Logo}
  ...
  export default FinancialManagementandResourceMobilization;
