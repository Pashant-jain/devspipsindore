...
const InternalQualityAssuranceSystem = () => {
    ...
    return (
      <>
        ...
        <Banner
          isFrontBanner={false}
          bannerImg={bannerImg}
          heading={"Internal Quality Assurance System"}
        />
         <Features
          sectionGap="both"
          SectionImage={Logo}
        ...
        />
         <Features
          ...
          className="bg_white"
          leftImage={true}
          title={'Review of Teaching Learning'}
          content={
            <>
           <PageContent content={renderIframe('sample.pdf')} />
            </>
  ...
  export default InternalQualityAssuranceSystem;
