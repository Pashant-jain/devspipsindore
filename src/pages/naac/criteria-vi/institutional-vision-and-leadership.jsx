...
const InstitutionalVisionandLeadership = () => {
    ...
    return (
      <>
        ...
        <Banner
          isFrontBanner={false}
          bannerImg={bannerImg}
          heading={"Institutional Vision and Leadership"}
        />
         <Features
          sectionGap="both"
          SectionImage={Logo}
          ...
          className="bg_white"
          title={'Governance in Institution'}
          content={
            <>
  ...
  export default InstitutionalVisionandLeadership;
