...
const CurriculumEnrichment = () => {
      ...
      <>
        ...
        />
         <Features
          ...
          className="bg_white"
          title={'Courses with Experiential Learning'}
          content={
            <>
        ...
        <Features
          ...
          className="bg_white"
          leftImage={true}
          title={'Student Undertaking Project'}
          content={
            <>
           <PageContent content={renderIframe('sample.pdf')} />
            </>
  ...
  export default CurriculumEnrichment;
