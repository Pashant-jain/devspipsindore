...
const StudentPerformanceandLearningOutcomes = () => {
    ...
    return (
      <>
        ...
        <Banner
          isFrontBanner={false}
          bannerImg={bannerImg}
          heading={"Student Performance and Learning Outcomes"}
        />
         <Features
          sectionGap="bottom"
          SectionImage={Logo}
        ...
        />
          ...
          descriptionClass="about_message"
          className="bg_white"
          title={'Use of ICT enabled tools'}
          content={
            <>
           <PageContent content={renderIframe('sample.pdf')} />
            </>
  ...
  export default StudentPerformanceandLearningOutcomes;
