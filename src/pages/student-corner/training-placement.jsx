    ...
    <>
      ...
      <main>
        ...
        <Features
          ...
          content={
            <>
              Ragging or any kind of harassment among the students is strictly
              prohibited. As per the government regulations, any student found
              indulging in RAGGING or harassing a fellow student is liable for
              criminal prosecution, expulsion from the college, debarring from
              admission to any other specified institution for a specific
              period, withholding scholarships or other benefits, cancellation,
              of admission, fine of Rs. 25000, imprisonment, etc
            </>
          }
        />
