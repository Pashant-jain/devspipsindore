...
const Clubs = () => {
  return (
    <>
      ...
      <Banner bannerImg={bannerImg} heading="GREEN FEATURES" description="Lorem ipsum dolor sit amet consectetur adipiscing eli mattis sit phasellus mollis sit aliquam sit nullam."  />
        <CommitteeList
          sectionGap="both"
          title="GREEN CLUB COMMITTEE"
